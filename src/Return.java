 ...
 * Return.java
 *
 * Created on 22 Jun, 2015, 11:47:05 AM
 */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
         ...
         ec.rs=ec.pst.executeQuery();
            if(ec.rs.next())
            {
                ec.pst=ec.con.prepareStatement("select * from member where name=? and book_issued=?");
                ec.pst.setString(1,jTextField1.getText());
                ec.pst.setString(2,jTextField2.getText());
                ec.rs=ec.pst.executeQuery();
                if(ec.rs.next())
                {
                ec.pst=ec.con.prepareStatement("update member set book_issued=null,issue_date=null,return_date=null where name=?");
                ec.pst.setString(1,jTextField1.getText());
                ec.pst.executeUpdate();
                ec.pst=ec.con.prepareStatement("update book set status='available' where bookname=?");
                ec.pst.setString(1,jTextField2.getText());
                ec.pst.executeUpdate();
                JOptionPane.showMessageDialog(null,jTextField2.getText()+" returned ") ;
                }
                else
                {
                    JOptionPane.showMessageDialog(null,jTextField2.getText()+" is not issued to "+jTextField1.getText()) ;
                }
